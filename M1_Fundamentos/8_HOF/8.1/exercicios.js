...
const isEqual = (num1, num2) => num1 === num2? 'Parabéns, você ganhou!' : 'Tente novamente';

const HOF = (betNumber, func) => {
  const randomNumber = Math.round(Math.random() * 5);
  console.log(randomNumber);
  return func(betNumber, randomNumber);
}
...
const highOrder = (feedbackArray, answersArray, func) => {
  return `Your score is ${func(feedbackArray, answersArray)}`;
}
